...
namespace XBLMS.Core.Repositories
{
    public class ExamAssessmentConfigRepository : IExamAssessmentConfigRepository
    {
        ...
        public async Task<List<ExamAssessmentConfig>> GetListWithoutLockedAsync(AuthorityAuth auth)
        {
        ...
        public async Task<(int total, List<ExamAssessmentConfig> list)> GetListAsync(AuthorityAuth auth, string keyWords, int pageIndex, int pageSize)
        {
