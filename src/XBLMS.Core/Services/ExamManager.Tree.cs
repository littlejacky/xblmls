...
namespace XBLMS.Core.Services
{
    ...
    {
        public async Task<List<Cascade<int>>> GetExamTmTreeCascadesAsync(AuthorityAuth auth, bool isTotal = false)
        {
            var list = new List<Cascade<int>>();
            var trees = await _examTmTreeRepository.GetListAsync(auth);
