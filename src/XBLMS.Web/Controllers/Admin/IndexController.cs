...
namespace XBLMS.Web.Controllers.Admin
{
    ...
    public partial class IndexController : ControllerBase
    {
        ...
        public IndexController(ISettingsManager settingsManager, IAuthManager authManager, IPathManager pathManager, IConfigRepository configRepository, IAdministratorRepository administratorRepository, IDbCacheRepository dbCacheRepository, IOrganCompanyRepository organCompanyRepository, IOrganDepartmentRepository organDepartmentRepository)
        {
        ...
        public class Local
        {
            ...
            public string CurOrganName { get; set; }
            public bool IsOrganAdmin { get; set; }
        }
