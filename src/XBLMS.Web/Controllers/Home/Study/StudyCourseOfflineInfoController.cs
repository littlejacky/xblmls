...
namespace XBLMS.Web.Controllers.Home.Study
{
    ...
    public partial class StudyCourseOfflineInfoController : ControllerBase
    {
        private const string Route = "study/studyCourseOfflineInfo";
        ...
        public StudyCourseOfflineInfoController(IConfigRepository configRepository,
